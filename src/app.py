...
activities = {
    ...
    ,
    "Soccer Team": {
        "description": "Join intramural and interschool soccer matches",
        "schedule": "Mondays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 22,
        "participants": ["noah@mergington.edu", "ava@mergington.edu"]
    },
    "Basketball Team": {
        "description": "Practice skills and compete in school basketball games",
...
@app.get("/activities")
def get_activities():
    # Return activities with no-store cache header so clients always fetch fresh data
